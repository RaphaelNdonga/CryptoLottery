...
def get_million_draw():
    ...
    million_draw = Contract.from_abi(
        MillionDraw._name, contract_address, MillionDraw.abi
    )
    return million_draw
...
def fund_with_lot(
    contract_address, account=None, lot_coin=None, entryFee=Web3.toWei(1000, "ether")
):
